...
* Added: new option for tabs. You can now link any tab to any webpage [hq_tab url="http://" target="blank"]
...
* Fixed: lightbox and galleries scripts, [forum topic](http://wordpress.org/support/topic/carousel-hq-little-hack)
