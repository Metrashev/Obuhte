...
class HQ_Widget extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
            <?php HQ_Generator::button(array('target' => $this->get_field_id('content'))); ?><br/>
...
add_action('widgets_init', array('HQ_Widget', 'register'));
