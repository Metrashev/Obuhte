    ...
    public static function about($field, $config) {
        ...
        <div id="hq-about-screen">
            ...
            <div class="sunrise-inline-menu">
                ...
                <a href="http://wordpress.org/support/plugin/shortcodes-ultimate/" target="_blank"><?php _e('hqpport forum', 'su'); ?></a>
            ...
            <div class="hq-clearfix">
                <div class="hq-about-column">
                    ...
                    <a href="http://www.youtube.com/watch?v=DR2c266yWEA?autoplay=1&amp;showinfo=0&amp;rel=0&amp;theme=light#" target="_blank" class="hq-demo-video"><img src="<?php echo plugins_url('assets/images/banners/how-it-works.jpg', HQ_PLUGIN_FILE); ?>" alt=""></a>
                </div>
                <div class="hq-about-column">
    ...
    public static function custom_css($field, $config) {
        ...
        <div id="hq-custom-css-screen">
            <div class="hq-custom-css-originals">
                ...
                <?php do_action('hq/admin/css/originals/after'); ?>
            </div>
        ...
        foreach ($examples as $group) {
            ...
            if (isset($group['items']))
                foreach ($group['items'] as $item) {
                    $code = ( isset($item['code']) ) ? $item['code'] : plugins_url('inc/examples/' . $item['id'] . '.example', HQ_PLUGIN_FILE);
    ...
    public static function addons($field, $config) {
        ...
        $addons = array(
            array(
                ...
                'image' => plugins_url('assets/images/banners/extra.png', HQ_PLUGIN_FILE)
            ),
            array(
                'name' => __('Maker', 'su'),
                ...
                'image' => plugins_url('assets/images/banners/maker.png', HQ_PLUGIN_FILE)
            ),
            array(
                'name' => __('Skins', 'su'),
                ...
                'image' => plugins_url('assets/images/banners/skins.png', HQ_PLUGIN_FILE)
            ),
            array(
                ...
                'image' => plugins_url('assets/images/banners/bundle.png', HQ_PLUGIN_FILE)
            ),
        );
        $plugins = array();
