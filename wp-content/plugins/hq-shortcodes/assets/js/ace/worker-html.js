...
(function (e) {
...
})(this), define("ace/mode/html_worker", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/worker/mirror", "ace/mode/html/saxparser"], function (e, t, n) {
    ...
    n.exports = function r(t, n, i) {
        ...
        return s
                ...
                var o = e("html5-entities"), u = e("./InputStream").InputStream, a = {};
                Object.keys(o).forEach(function (e) {
                    for (var t = 0; t < e.length; t++)
                        a[e.substring(0, t + 1)] = !0
                });
                var f = {};
                f.consumeEntity = function (e, t, n) {
                    ...
                    if (c >= "a" && c <= "z" || c >= "A" && c <= "Z") {
                        ...
                        return y ? (f = o[y], c === ";" || !n || !r(c) && c !== "=" ? (l.length > y.length && e.unget(l.substring(y.length)), c !== ";" && t._parseError("named-entity-without-semicolon"), f) : (e.unget(l), !1)) : (t._parseError("expected-named-entity"), e.unget(l), !1)
                    }
                ...
                s.prototype._parseError = function (e, t) {
                    ...
                    function t(e) {
                        ...
                        if (t === "&")
                            ...
                            wt._emitToken({type: "Characters", data: t}), e.commit();
                        else {
                    ...
                    function T(e) {
                        ...
                        if (n === o.EOF)
                            ...
                            wt._emitToken({type: "Characters", data: "-"}), wt.setState(N);
                        else if (n === "<")
                            wt.setState(k);
                        else if (n === "\0")
                            wt._parseError("invalid-codepoint"), wt._emitToken({type: "Characters", data: "�"}), e.commit();
                    ...
                    function I(e) {
                        var n = e.char();
                        if (n === o.EOF)
                            wt._parseError("expected-attribute-name-but-got-eof"), e.unget(n), wt.setState(t);
                        else {
                            if (r(n))
                                return!0;
                    ...
                    function R(e) {
                        var n = e.char();
                        if (n === o.EOF)
                            wt._parseError("expected-end-of-tag-but-got-eof"), e.unget(n), wt.setState(t);
                        else {
                            if (r(n))
                                return!0;
                    ...
                    function U(e) {
                        var n = e.char();
                        if (n === o.EOF)
                            wt._parseError("expected-attribute-value-but-got-eof"), e.unget(n), wt.setState(t);
                        else {
                            if (r(n))
                                return!0;
                    ...
                    function z(e) {
                        var n = e.char();
                        if (n === o.EOF)
                            wt._parseError("eof-in-attribute-value-double-quote"), e.unget(n), wt.setState(t);
                        else if (n === '"')
                            wt.setState($);
                        else if (n === "&")
                    ...
                    function X(e) {
                        ...
                        if (n === o.EOF)
                            ...
                            wt._parseError("unexpected-character-in-unquoted-attribute-value"), wt._currentAttribute().nodeValue += n, e.commit();
                        else if (n === "\0")
                            wt._parseError("invalid-codepoint"), wt._currentAttribute().nodeValue += "�";
                        else {
                    ...
                    function Q(e) {
                        var t = e.shift(2);
                        if (t === "--")
                            wt._currentToken = {type: "Comment", data: ""}, wt.setState(Y);
                        else {
                            var n = e.shift(5);
                            if (n === o.EOF || t === o.EOF)
                    ...
                    function ut(e) {
                        var n = e.char();
                        if (n === o.EOF)
                            wt._currentToken.forceQuirks = !0, e.unget(n), wt._parseError("eof-in-doctype"), wt.setState(t), wt._emitCurrentToken();
                        else if (!r(n))
                            if (n === ">")
                                wt.setState(t), wt._emitCurrentToken();
                            else {
                                if (["p", "P"].indexOf(n) > -1) {
                                    var i = [["u", "U"], ["b", "B"], ["l", "L"], ["i", "I"], ["c", "C"]], s = i.every(function (t) {
                                        return n = e.char(), t.indexOf(n) > -1
                                    });
                                    if (s)
                                        return wt.setState(at), !0
                                } else if (["s", "S"].indexOf(n) > -1) {
                                    var i = [["y", "Y"], ["s", "S"], ["t", "T"], ["e", "E"], ["m", "M"]], s = i.every(function (t) {
                                        return n = e.char(), t.indexOf(n) > -1
                                    });
                                    if (s)
                                        return wt.setState(dt), !0
                                }
                    ...
                    while (this._state.call(this, this._inputStream))
                        ;
                }, Object.defineProperty(s.prototype, "lineNumber", {get: function () {
                        return this._inputStream.location().line
                    }}), Object.defineProperty(s.prototype, "columnNumber", {get: function () {
                ...
                function f() {
                    ...
                    t.base = {end_tag_handlers: {"-default": "endTagOther"}, start_tag_handlers: {"-default": "startTagOther"}, processEOF: function () {
                        ...
                        e.insertElement(t, n), e.tokenizer.setState(v.SCRIPT_DATA), e.originalInsertionMode = e.insertionModeName, e.setInsertionMode("text")
                        ...
                        e.parseError("unexpected-start-tag", {name: "body"}), e.openElements.length == 1 || e.openElements.item(1).localName != "body" ? c.ok(e.context) : (e.framesetOk = !1, e.addAttributesToElement(e.openElements.bodyElement, n))
                        ...
                        e.openElements.inButtonScope("p") && this.endTagP("p"), e.insertElement(t, n), e.tokenizer.setState(v.PLAINTEXT)
                        ...
                        e.reconstructActiveFormattingElements(), e.insertElement(t, n), e.activeFormattingElements.push(y), e.framesetOk = !1
                        ...
                        i.push({nodeName: "name", nodeValue: "isindex"}), this.processStartTag("form", r), this.processStartTag("hr"), this.processStartTag("label"), this.processCharacters(new a(s)), this.processStartTag("input", i), this.processEndTag("label"), this.processStartTag("hr"), this.processEndTag("form")
                    }, t.inBody.startTagTextarea = function (t, n) {
                        e.insertElement(t, n), e.tokenizer.setState(v.RCDATA), e.originalInsertionMode = e.insertionModeName, e.shouldSkipLeadingNewline = !0, e.framesetOk = !1, e.setInsertionMode("text")
                        ...
                        this.ignoreEndTagColgroup() ? (c.ok(e.context), e.parseError("unexpected-end-tag", {name: t})) : (e.popElement(), e.setInsertionMode("inTable"))
                        ...
                        n = n.replace(/\u0000/g, function (t, n) {
                            return e.parseError("invalid-codepoint"), "�"
                        }), e.framesetOk && !o(n) && (e.framesetOk = !1), e.insertText(n)
                        ...
                        e.openElements.popUntilTableScopeMarker(), e.activeFormattingElements.push(y), e.insertElement(t, n), e.setInsertionMode("inCaption")
                        ...
                        e.openElements.inTableScope(t) ? (e.generateImpliedEndTags(), e.currentStackItem().localName != t && e.parseError("end-tag-too-early-named", {gotName: "table", expectedName: e.currentStackItem().localName}), e.openElements.popUntilPopped("table"), e.resetInsertionMode()) : (c.ok(e.context), e.parseError("unexpected-end-tag", {name: t}))
                        ...
                        s(t) ? e.insertText(t) : (e.redirectAttachToFosterParent = !0, e.reconstructActiveFormattingElements(), e.insertText(t), e.framesetOk = !1, e.redirectAttachToFosterParent = !1), e.pendingTableCharacters = []
                        ...
                        e.openElements.popUntilTableRowScopeMarker(), e.insertElement(t, n), e.setInsertionMode("inCell"), e.activeFormattingElements.push(y)
                        ...
                        this.ignoreEndTagTr() ? (c.ok(e.context), e.parseError("unexpected-end-tag", {name: t})) : (e.openElements.popUntilTableRowScopeMarker(), e.popElement(), e.setInsertionMode("inTableBody"))
                        ...
                        i && (e.reconstructActiveFormattingElements(), e.insertText(i)), i.length < n.length && e.parseError("expected-eof-but-got-char")
                ...
                var c = e("assert"), h = e("./messages.json"), p = e("./constants"), d = e("events").EventEmitter, v = e("./Tokenizer").Tokenizer, m = e("./ElementStack").ElementStack, g = e("./StackItem").StackItem, y = {};
                a.prototype.skipAtMostOneLeadingNewline = function () {
                    this.characters[this.current] === "\n" && this.current++
                }, a.prototype.skipLeadingWhitespace = function () {
                    while (r(this.characters[this.current]))
                    ...
                    while (s++ < n) {
                        ...
                        if (!this.openElements.contains(i))
                            return this.parseError("adoption-agency-1.2", {name: e}), this.removeElementFromActiveFormattingElements(i), !0;
                        ...
                        if (!o)
                            return this.openElements.remove_openElements_until(t), this.removeElementFromActiveFormattingElements(i), !0;
                        ...
                        while (p++ < r) {
                            ...
                            var d = this.createElement(l.namespaceURI, l.localName, l.attributes), v = new g(l.namespaceURI, l.localName, l.attributes, d);
                        ...
                        var d = this.createElement("http://www.w3.org/1999/xhtml", i.localName, i.attributes), m = new g(i.namespaceURI, i.localName, i.attributes, d);
                        this.reparentChildren(o.node, d), this.attachNode(d, o.node), this.removeElementFromActiveFormattingElements(i), this.activeFormattingElements.splice(Math.min(f, this.activeFormattingElements.length), 0, m), this.openElements.remove(i), this.openElements.elements.splice(this.openElements.elements.indexOf(o) + 1, 0, m)
                    }
                    return!0
                }, f.prototype.start = function () {
                    throw"Not mplemented"
                }, f.prototype.startTokenization = function (e) {
                    this.tokenizer = e, this.compatMode = "no quirks", this.originalInsertionMode = "initial", this.framesetOk = !0, this.openElements = new m, this.activeFormattingElements = [], this.start();
                    if (this.context) {
                        switch (this.context) {
                            case"title":
                            case"textarea":
                    ...
                    return this.attachNode(t, this.document), this.openElements.pushHtmlElement(new g("http://www.w3.org/1999/xhtml", "html", e, t)), t
                }, f.prototype.insertHeadElement = function (e) {
                    var t = this.createElement("http://www.w3.org/1999/xhtml", "head", e);
                    return this.head = new g("http://www.w3.org/1999/xhtml", "head", e, t), this.attachNode(t, this.openElements.top.node), this.openElements.pushHeadElement(this.head), t
                }, f.prototype.insertBodyElement = function (e) {
                    var t = this.createElement("http://www.w3.org/1999/xhtml", "body", e);
                    return this.attachNode(t, this.openElements.top.node), this.openElements.pushBodyElement(new g("http://www.w3.org/1999/xhtml", "body", e, t)), t
                    ...
                    this.shouldFosterParent() ? this.insertIntoFosterParent(i) : this.attachNode(i, this.openElements.top.node), r || this.openElements.push(new g(n, e, t, i))
                    ...
                    if (t == y || this.openElements.contains(t))
                        return;
                    ...
                    if (n.length < t)
                        return;
                    var o = [], a = e.attributes;
                    for (var i = 0; i < a.length; i++) {
                        var f = a[i];
                        for (var l = 0; l < n.length; l++) {
                            var s = n[l], c = u(s, f.nodeName);
                    ...
                    for (var n = this.openElements.length - 1; n >= 0; n--) {
                        t = this.openElements.item(n), n === 0 && (c.ok(this.context), e = !0, t = new g("http://www.w3.org/1999/xhtml", this.context, [], null));
                    ...
                    this.insertElement(e, t), this.tokenizer.setState(v.RCDATA), this.originalInsertionMode = this.insertionModeName, this.setInsertionMode("text")
                }, f.prototype.processGenericRawTextStartTag = function (e, t) {
                    this.insertElement(e, t), this.tokenizer.setState(v.RAWTEXT), this.originalInsertionMode = this.insertionModeName, this.setInsertionMode("text")
                }, f.prototype.adjustMathMLAttributes = function (e) {
                    return e.forEach(function (e) {
                        e.namespaceURI = "http://www.w3.org/1998/Math/MathML", p.MATHMLAttributeMap[e.nodeName] && (e.nodeName = p.MATHMLAttributeMap[e.nodeName])
                    }), e
                }, f.prototype.adjustSVGTagNameCase = function (e) {
                    return p.SVGTagMap[e] || e
                }, f.prototype.adjustSVGAttributes = function (e) {
                    return e.forEach(function (e) {
                        e.namespaceURI = "http://www.w3.org/2000/svg", p.SVGAttributeMap[e.nodeName] && (e.nodeName = p.SVGAttributeMap[e.nodeName])
                    }), e
                }, f.prototype.adjustForeignAttributes = function (e) {
                    for (var t = 0; t < e.length; t++) {
                        var n = e[t], r = p.ForeignAttributeMap[n.nodeName];
                ...
                function f(e, t, n, r, i, s) {
                    o.call(this, e), this.uri = t, this.localName = n, this.qName = r, this.attributes = i, this.prefixMappings = s, this.nodeType = w.ELEMENT
                }
                function l(e, t) {
                ...
                y.inherits(r, b), r.prototype.start = function (e) {
                    ...
                    if (this.redirectAttachToFosterParent && this.openElements.top.isFosterParenting()) {
                        ...
                        var i = new l(this.tokenizer, e), s = r.parentNode;
                        if (s) {
                ...
                }, Object.defineProperty(o.prototype, "endLocator", {get: function () {
                ...
                function r(e, t) {
                    return p.isUndefined(t) ? "" + t : p.isNumber(t) && (isNaN(t) || !isFinite(t)) ? t.toString() : p.isFunction(t) || p.isRegExp(t) ? t.toString() : t
                }
                function i(e, t) {
                ...
                function a(e, t) {
                    ...
                    return p.isDate(e) && p.isDate(t) ? e.getTime() === t.getTime() : p.isRegExp(e) && p.isRegExp(t) ? e.source === t.source && e.global === t.global && e.multiline === t.multiline && e.lastIndex === t.lastIndex && e.ignoreCase === t.ignoreCase : !p.isObject(e) && !p.isObject(t) ? e == t : l(e, t)
                }
                function f(e) {
                    return Object.prototype.toString.call(e) == "[object Arguments]"
                }
                function l(e, t) {
                    if (p.isNullOrUndefined(e) || p.isNullOrUndefined(t))
                        return!1;
                    if (e.prototype !== t.prototype)
                        return!1;
                    if (f(e))
                        return f(t) ? (e = d.call(e), t = d.call(t), a(e, t)) : !1;
                    try {
                        var n = g(e), r = g(t), i, s
                    } catch (o) {
                        return!1
                ...
                function h(e, t, n, r) {
                    ...
                    r = (n && n.name ? " (" + n.name + ")." : ".") + (r ? " " + r : "."), e && !i && o(i, n, "Missing expected exception" + r), !e && c(i, n) && o(i, n, "Got unwanted exception" + r);
                    if (e && i && n && !c(i, n) || !e && i)
                        throw i
                }
                var p = e("util/"), d = Array.prototype.slice, v = Object.prototype.hasOwnProperty, m = t.exports = u;
                m.AssertionError = function (e) {
                    this.name = "AssertionError", this.actual = e.actual, this.expected = e.expected, this.operator = e.operator, e.message ? (this.message = e.message, this.generatedMessage = !1) : (this.message = s(this), this.generatedMessage = !0);
                    ...
                    if (Error.captureStackTrace)
                        ...
                        var n = new Error;
                        if (n.stack) {
                            var r = n.stack, i = t.name, u = r.indexOf("\n" + i);
                            if (u >= 0) {
                                var a = r.indexOf("\n", u + 1);
                                r = r.substring(a + 1)
                            }
                ...
                }, p.inherits(m.AssertionError, Error), m.fail = o, m.ok = u, m.equal = function (e, t, n) {
                    e != t && o(e, t, n, "==", m.equal)
                ...
                (function (t, r) {
                    function i(e, t) {
                        ...
                        return arguments.length >= 3 && (r.depth = arguments[2]), arguments.length >= 4 && (r.colors = arguments[3]), v(t) ? r.showHidden = t : t && n._extend(r, t), E(r.showHidden) && (r.showHidden = !1), E(r.depth) && (r.depth = 2), E(r.colors) && (r.colors = !1), E(r.customInspect) && (r.customInspect = !0), r.colors && (r.stylize = s), a(r, e, r.depth)
                    }
                    function s(e, t) {
                        var n = i.styles[t];
                    ...
                    function a(e, t, r) {
                        ...
                        if (s)
                            return s;
                        var o = Object.keys(t), v = u(o);
                        e.showHidden && (o = Object.getOwnPropertyNames(t));
                        if (N(t) && (o.indexOf("message") >= 0 || o.indexOf("description") >= 0))
                            return l(t);
                        if (o.length === 0) {
                            if (C(t)) {
                                var m = t.name ? ": " + t.name : "";
                        ...
                        S(t) && (g = " " + RegExp.prototype.toString.call(t)), T(t) && (g = " " + Date.prototype.toUTCString.call(t)), N(t) && (g = " " + l(t));
                        if (o.length !== 0 || !!y && t.length != 0) {
                            if (r < 0)
                                return S(t) ? e.stylize(RegExp.prototype.toString.call(t), "regexp") : e.stylize("[Object]", "special");
                            e.seen.push(t);
                            var x;
                            return y ? x = c(e, t, r, v, o) : x = o.map(function (n) {
                    ...
                    function h(e, t, n, r, i, s) {
                        var o, u, f;
                        f = Object.getOwnPropertyDescriptor(t, i) || {value: t[i]}, f.get ? f.set ? u = e.stylize("[Getter/Setter]", "special") : u = e.stylize("[Getter]", "special") : f.set && (u = e.stylize("[Setter]", "special")), M(r, i) || (o = "[" + i + "]"), u || (e.seen.indexOf(f.value) < 0 ? (m(n) ? u = a(e, f.value, null) : u = a(e, f.value, n - 1), u.indexOf("\n") > -1 && (s ? u = u.split("\n").map(function (e) {
                            return"  " + e
                        }).join("\n").substr(2) : u = "\n" + u.split("\n").map(function (e) {
                            return"   " + e
                    ...
                    n.format = function (e) {
                        ...
                        var n = 1, r = arguments, s = r.length, o = String(e).replace(_, function (e) {
                            if (e === "%%")
                                return"%";
                            if (n >= s)
                                return e;
                ...
                }(), i.title = "browser", i.browser = !0, i.env = {}, i.argv = [], i.on = r, i.once = r, i.off = r, i.emit = r, i.binding = function (e) {
