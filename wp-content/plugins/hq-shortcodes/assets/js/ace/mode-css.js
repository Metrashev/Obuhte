        ...
        this.add("braces", "insertion", function (e, t, n, r, i) {
            ...
            if (i == "{") {
                ...
                if (h.isSaneInsertion(n, r))
                    return/[\]\}\)]/.test(u[s.column]) || n.inMultiSelectMode ? (h.recordAutoInsert(n, r, "}"), {text: "{}", selection: [1, 1]}) : (h.recordMaybeInsert(n, r, "{"), {text: "{", selection: [1, 1]})
            } else if (i == "}") {
                c(n);
            ...
            if (i == '"' || i == "'") {
                ...
                for (var g = 0; g < p.length; g++) {
                    ...
                    if (v.value.length + d > o.start.column)
                        break;
                    d += p[g].value.length
                }
