define("ace/ext/language_tools", ["require", "exports", "module", "ace/snippets", "ace/autocomplete", "ace/config", "ace/autocomplete/util", "ace/autocomplete/text_completer", "ace/editor"], function (e, t, n) {
    var r = e("../snippets").snippetManager, i = e("../autocomplete").Autocomplete, s = e("../config"), o = e("../autocomplete/util"), u = e("../autocomplete/text_completer"), a = {getCompletions: function (e, t, n, r, i) {
            var s = e.session.getState(n.row), o = t.$mode.getCompletions(s, t, n, r);
            i(null, o)
        }}, f = {getCompletions: function (e, t, n, i, s) {
    ...
    var c = {name: "expandSnippet", exec: function (e) {
            var t = r.expandWithTab(e);
            t || e.execCommand("indent")
        }, bindKey: "Tab"}, h = function (e, t) {
        p(t.session.$mode)
    }, p = function (e) {
        var t = e.$id;
        ...
        var t = e.editor, n = e.args || "", r = t.getCursorPosition(), s = t.session.getLine(r.row), u = t.completer && t.completer.activated, a = o.retrievePrecedingIdentifier(s, r.column);
        l.forEach(function (e) {
            e.identifierRegexps && e.identifierRegexps.forEach(function (e) {
                a || (a = o.retrievePrecedingIdentifier(s, r.column, e))
            })
        }), e.command.name === "backspace" && !a ? u && t.completer.detach() : e.command.name === "insertstring" && (a && !u ? (t.completer || (t.completer = new i, t.completer.autoSelect = !1, t.completer.autoInsert = !1), t.completer.showPopup(t)) : !a && u && t.completer.detach())
    }, m = e("../editor").Editor;
    e("../config").defineOptions(m.prototype, "editor", {enableBasicAutocompletion: {set: function (e) {
                e ? (this.completers = Array.isArray(e) ? e : l, this.commands.addCommand(i.startCommand)) : this.commands.removeCommand(i.startCommand)
            }, value: !1}, enableLiveAutocompletion: {set: function (e) {
                e ? (this.completers = Array.isArray(e) ? e : l, this.commands.on("afterExec", v)) : this.commands.removeListener("afterExec", v)
            }, value: !1}, enableSnippets: {set: function (e) {
                e ? (this.commands.addCommand(c), this.on("changeMode", h), h(null, this)) : (this.commands.removeCommand(c), this.off("changeMode", h))
            }, value: !1}})
    ...
    (function () {
        this.gatherCompletionsId = 0, this.$init = function () {
            ...
            e.completer || (e.completer = new f), e.completer.autoInsert = e.completer.autoSelect = !0, e.completer.showPopup(e), e.completer.cancelContextMenu()
    ...
    var r = e("../edit_session").EditSession, i = e("../virtual_renderer").VirtualRenderer, s = e("../editor").Editor, o = e("../range").Range, u = e("../lib/event"), a = e("../lib/lang"), f = e("../lib/dom"), l = function (e) {
        ...
        return d.$tokenizeRow = function (e) {
            ...
            for (var e = 0; e < t.caption.length; e++)
                o = t.caption[e], s = t.matchMask & 1 << e ? 1 : 0, i !== s ? (r.push({type: t.className || "" + (s ? "completion-highlight" : ""), value: o}), i = s) : r[r.length - 1].value += o;
            if (t.meta) {
